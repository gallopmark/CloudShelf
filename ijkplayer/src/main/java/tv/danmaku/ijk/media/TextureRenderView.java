...
public class TextureRenderView extends TextureView implements IRenderView {
    ...
    private static final class InternalSurfaceHolder implements IRenderView.ISurfaceHolder {
        ...
        InternalSurfaceHolder(@NonNull TextureRenderView textureView, @Nullable SurfaceTexture surfaceTexture) {
        ...
        public void bindToMediaPlayer(IMediaPlayer mp) {
            ...
            if ((Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) && (mp instanceof ISurfaceTextureHolder)) {
                ...
                mTextureView.mSurfaceCallback.setOwnSurfaceTexture();
    ...
    private static final class SurfaceCallback implements SurfaceTextureListener {
        ...
        void setOwnSurfaceTexture() {
            mOwnSurfaceTecture = false;
        }
